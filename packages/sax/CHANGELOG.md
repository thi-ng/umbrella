...
## [2.3.0](https://github.com/thi-ng/umbrella/tree/@thi.ng/sax@2.3.0) (2025-11-13)

#### 🚀 Features

- add `parseAsHiccup()`, `parseAsTree()` ([ac3fd8d](https://github.com/thi-ng/umbrella/commit/ac3fd8d))

#### 🩹 Bug fixes

- update set of valid unicode chars in tag names ([f267fbf](https://github.com/thi-ng/umbrella/commit/f267fbf))
