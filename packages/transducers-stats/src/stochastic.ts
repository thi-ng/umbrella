 ...
 * @param periodD2
 */
export function stochastic(periodK?: number, periodD1?: number, periodD2?: number): Transducer<number, Stochastic>;
export function stochastic(src: Iterable<number>): IterableIterator<Stochastic>;
export function stochastic(periodK: number, periodD1: number, periodD2: number, src: Iterable<number>): IterableIterator<Stochastic>;
export function stochastic(...args: any[]): any {
    return $iter(stochastic, args) ||
