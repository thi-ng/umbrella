...
describe("fuzzy", () => {
    it("strings", () => {
        ...
        assert.deepEqual([...filterFuzzy("he", opts)], ["hello", "hey", "heyoka"]);
        assert.deepEqual([...filterFuzzy("ho", opts)], ["hello", "hallo", "heyoka"]);
    ...
    it("arrays", () => {
        ...
        assert.deepEqual([...filterFuzzy([1, 3], opts)], [[1, 2, 3], [1, 3, 4], [1, 3, 6]]);
        assert.deepEqual([...filterFuzzy([4], opts)], [[1, 3, 4], [4, 5, 6]]);
