...
export const d = defUnit("d", "day", mul(h, 24));
export const week = defUnit("w", "week", mul(d, 7));
export const month = defUnit("mo", "month", mul(d, 30));
export const year = defUnit("y", "year", mul(d, 365.25));
