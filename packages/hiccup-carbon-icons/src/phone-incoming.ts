...
/**
 * https://demo.thi.ng/umbrella/hiccup-carbon-icons/#PHONE_INCOMING
 */
// prettier-ignore
export const PHONE_INCOMING: any[] = svg(
...
path("M27 13v-2h-4.586L29 4.414 27.586 3 21 9.586V5h-2v8z"),
);