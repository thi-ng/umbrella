...
export const scaleV44 = (m: Mat, v: ReadonlyVec, i = 0) =>
...
export const scaleWithCenter44 = (m: Mat, p: ReadonlyVec, sx: number, sy: number, sz: number, im = 0) =>
    concat44(
...
export const translationV44 = (m: Mat, v: ReadonlyVec, i = 0) =>
...
export const lookAt = (m: Mat, eye: ReadonlyVec, target: ReadonlyVec, up: ReadonlyVec, im = 0) => {
...
export const mulV344 = (v: Vec, m: ReadonlyMat, im = 0) =>
    setS3(
        v,
...
export const mulV44 = (v: Vec, m: ReadonlyMat, im = 0) =>
    setS4(
        v,
        dot4(m, v, im, 0, 4),
        dot4(m, v, im + 1, 0, 4),
