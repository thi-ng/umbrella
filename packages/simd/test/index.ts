...
// add4_f32
simd.add4_f32(1024, 0, 48, 2, 4, 4, 4);
assertEqual(res_f32(1024, 8), [11, 22, 33, 44, 55, 66, 77, 88]);
// addn4_f32
simd.addn4_f32(1024, 0, 10, 2, 4, 4);
assertEqual(res_f32(1024, 8), [11, 12, 13, 14, 15, 16, 17, 18]);
// sub4_f32
simd.sub4_f32(1024, 0, 48, 2, 4, 4, 4);
assertEqual(res_f32(1024, 8), [-9, -18, -27, -36, -45, -54, -63, -72]);
// subn4_f32
simd.subn4_f32(1024, 0, 10, 2, 4, 4);
assertEqual(res_f32(1024, 8), [-9, -8, -7, -6, -5, -4, -3, -2]);
// mul4_f32
simd.mul4_f32(1024, 0, 48, 2, 4, 4, 4);
assertEqual(res_f32(1024, 8), [10, 40, 90, 160, 250, 360, 490, 640]);
// muln4_f32
...
simd.abs4_f32(1024, 0, 2, 4, 4);
assertEqual(res_f32(1024, 8), [1, 2, 3, 4, 5, 6, 7, 8]);
// neg4_f32
simd.neg4_f32(1024, 0, 2, 4, 4);
assertEqual(res_f32(1024, 8), [1, -2, 3, -4, -5, 6, -7, 8]);
...
simd.clamp4_f32(1024, 0, 32, 48, 2, 4, 4, 0, 0);
assertEqual(res_f32(1024, 8), [-1, 2, -3, 4, 1, -2, 3, -4]);
//clampn4_f32
simd.clampn4_f32(1024, 0, -1, 1, 2, 4, 4);
assertEqual(res_f32(1024, 8), [-1, 1, -1, 1, 1, -1, 1, -1]);
//min4_f32
simd.min4_f32(1024, 0, 32, 2, 4, 4, 0);
assertEqual(res_f32(1024, 8), [-10, -2, -10, -4, -1, -10, -3, -10]);
simd.min4_f32(1024, 0, 48, 2, 4, 4, 0);
assertEqual(res_f32(1024, 8), [-10, 2, -10, 4, 1, -10, 3, -10]);
//max4_f32
simd.max4_f32(1024, 0, 32, 2, 4, 4, 0);
assertEqual(res_f32(1024, 8), [-1, 10, -3, 10, 10, -2, 10, -4]);
simd.max4_f32(1024, 0, 48, 2, 4, 4, 0);
assertEqual(res_f32(1024, 8), [1, 10, 3, 10, 10, 2, 10, 4]);
...
// msub4
simd.msub4_f32(1024, 0, 32, 64, 2, 4, 4, 4, 4);
// prettier-ignore
...
assertEqual(res_f32(1024, 8), [111, 222, 333, 444, 555, 666, 777, 888]);
// msubn4
simd.msubn4_f32(1024, 0, 11, 32, 2, 4, 4, 4);
// prettier-ignore
assertEqual(res_f32(1024, 8), [-89, -178, -267, -356, -445, -534, -623, -712]);
...
simd.normalize2_f32_aos(1024, 0, 4, 10);
assertEqualDelta(
    res_f32(1024, 8),
...
simd.normalize4_f32_aos(1024, 0, 4, 10, 4, 4);
assertEqualDelta(
    res_f32(1024, 16),
    // prettier-ignore
    [
