 ...
 * @param src
 */
export function fsm<T, C, R>(states: IObjectOf<Matcher<T, C, R>>, ctx: C, initial: string | number, update?: (ctx: C, x: T) => void): Transducer<T, R>;
export function fsm<T, C, R>(states: IObjectOf<Matcher<T, C, R>>, ctx: C, initial: string | number, update?: (ctx: C, x: T) => void, src?: Iterable<T>): IterableIterator<R>;
export function fsm<T, C, R>(states: IObjectOf<Matcher<T, C, R>>, ctx: C, initial: string | number = "start", update?: (ctx: C, x: T) => void, src?: Iterable<T>) {
    return src ?
