...
## [3.3.0](https://github.com/thi-ng/umbrella/tree/@thi.ng/logger@3.3.0) (2026-03-11)

#### 🚀 Features

- add Error & RegExp support for `expandArgsJSON()` ([0bd9ad5](https://github.com/thi-ng/umbrella/commit/0bd9ad5))
