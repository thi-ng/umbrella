/**
 * Generated by @thi.ng/wasm-api-bindgen at 2024-08-17T14:24:41.203Z
 * DO NOT EDIT!
 */
...
export const $WindowInfo: WasmTypeConstructor<WindowInfo> = (mem) => ({
	...
	instanceArray(base, num) {
		return __instanceArray<WindowInfo>(this, base, num);
	},
	instance: (base) => {
		return {
			get __base() {
...
export const $DragEvent: WasmTypeConstructor<DragEvent> = (mem) => ({
	...
	instanceArray(base, num) {
		return __instanceArray<DragEvent>(this, base, num);
	},
	instance: (base) => {
		return {
			get __base() {
...
export const $InputEvent: WasmTypeConstructor<InputEvent> = (mem) => ({
	...
	instanceArray(base, num) {
		return __instanceArray<InputEvent>(this, base, num);
	},
	instance: (base) => {
...
export const $PointerEvent: WasmTypeConstructor<PointerEvent> = (mem) => ({
	...
	instanceArray(base, num) {
		return __instanceArray<PointerEvent>(this, base, num);
	},
	instance: (base) => {
		return {
			get __base() {
...
export const $ScrollEvent: WasmTypeConstructor<ScrollEvent> = (mem) => ({
	...
	instanceArray(base, num) {
		return __instanceArray<ScrollEvent>(this, base, num);
	},
	instance: (base) => {
		return {
			get __base() {
...
export const $TouchEvent: WasmTypeConstructor<TouchEvent> = (mem) => ({
	...
	instanceArray(base, num) {
		return __instanceArray<TouchEvent>(this, base, num);
	},
	instance: (base) => {
		return {
			get __base() {
...
export const $WheelEvent: WasmTypeConstructor<WheelEvent> = (mem) => ({
	...
	instanceArray(base, num) {
		return __instanceArray<WheelEvent>(this, base, num);
	},
	instance: (base) => {
		return {
			get __base() {
...
export const $EventBody: WasmTypeConstructor<EventBody> = (mem) => ({
	...
	instanceArray(base, num) {
		return __instanceArray<EventBody>(this, base, num);
	},
	instance: (base) => {
		return {
			get __base() {
...
export const $EventListener: WasmTypeConstructor<EventListener> = (mem) => ({
	...
	instanceArray(base, num) {
		return __instanceArray<EventListener>(this, base, num);
	},
	instance: (base) => {
		return {
			get __base() {
...
export const $CreateElementOpts: WasmTypeConstructor<CreateElementOpts> = (mem) => ({
	...
	instanceArray(base, num) {
		return __instanceArray<CreateElementOpts>(this, base, num);
	},
	instance: (base) => {
...
export const $CreateCanvasOpts: WasmTypeConstructor<CreateCanvasOpts> = (mem) => ({
	...
	instanceArray(base, num) {
		return __instanceArray<CreateCanvasOpts>(this, base, num);
	},
	instance: (base) => {
		let $id: WasmStringPtr | null = null;
		let $class: WasmStringPtr | null = null;
...
export const $Attrib: WasmTypeConstructor<Attrib> = (mem) => ({
	...
	instanceArray(base, num) {
		return __instanceArray<Attrib>(this, base, num);
	},
	instance: (base) => {
...
export const $AttribValue: WasmTypeConstructor<AttribValue> = (mem) => ({
	...
	instanceArray(base, num) {
		return __instanceArray<AttribValue>(this, base, num);
	},
	instance: (base) => {
