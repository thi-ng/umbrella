//! Generated by @thi.ng/wasm-api at 2022-11-06T13:00:00.505Z - DO NOT EDIT!
...
pub const EventCallback = *const fn(event: *const Event, ctx: ?*anyopaque) void;

pub const RAFCallback = *const fn(time: f64, ctx: ?*anyopaque) void;
...
pub const Attrib = struct {
    ...
    pub fn event(name: []const u8, val: EventListener) Attrib {
        return Attrib{ .name = name, .kind = .event, .value = .{ .event = val } };
    }
