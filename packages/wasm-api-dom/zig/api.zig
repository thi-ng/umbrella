//! Generated by @thi.ng/wasm-api-bindgen at 2022-11-24T11:00:00.766Z
//! DO NOT EDIT!

const std = @import("std");
const wasmtypes = @import("wasmapi-types");

pub const CreateElementOptsSlice = wasmtypes.Slice([]CreateElementOpts, [*]CreateElementOpts);
pub const ConstCreateElementOptsSlice = wasmtypes.Slice([]const CreateElementOpts, [*]const CreateElementOpts);

pub const AttribSlice = wasmtypes.Slice([]Attrib, [*]Attrib);
pub const ConstAttribSlice = wasmtypes.Slice([]const Attrib, [*]const Attrib);
...
pub const InputEvent = extern struct {
    ...
    value: wasmtypes.ConstStringPtr,
...
pub const EventCallback = *const fn(event: *const Event, ctx: ?wasmtypes.OpaquePtr) void;

/// Function signature for RAF (requestAnimationFrame) event handler
pub const RAFCallback = *const fn(time: f64, ctx: ?wasmtypes.OpaquePtr) void;
...
pub const CreateElementOpts = extern struct {
    /// DOM element name
    tag: wasmtypes.ConstStringPtr,
    /// Namespace URI or wellknown registered alias (e.g. svg, xlink, xmlns)
    ns: wasmtypes.ConstStringPtr = "",
    /// ID attrib
    id: wasmtypes.ConstStringPtr = "",
    /// Element class attrib
    class: wasmtypes.ConstStringPtr = "",
    /// Element inner text body
    text: wasmtypes.ConstStringPtr = "",
    /// Element inner HTML body
    html: wasmtypes.ConstStringPtr = "",
