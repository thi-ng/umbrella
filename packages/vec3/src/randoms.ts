 ...
 */
export const randomS3: VecOpSOOO<number, number, IRandom> = (a,n=-1,m=1,rnd=op,ia=0,sa=1)=>{!a&&(a=[]);a[ia]=rnd.minmax(n,m);a[ia+sa]=rnd.minmax(n,m);a[ia+2*sa]=rnd.minmax(n,m);return a;};