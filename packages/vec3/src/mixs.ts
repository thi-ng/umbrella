 ...
 */
export const mixS3: VecOpSVVV = (o,a,b,c,io=0,ia=0,ib=0,ic=0,so=1,sa=1,sb=1,sc=1) => {
!o && (o=a);o[io]=a[ia]+(b[ib]-a[ia])*c[ic];o[io+so]=a[ia+sa]+(b[ib+sb]-a[ia+sa])*c[ic+sc];o[io+2*so]=a[ia+2*sa]+(b[ib+2*sb]-a[ia+2*sa])*c[ic+2*sc];return o;
};