 ...
 */
export const randMinMaxS3: VecOpSVVO<IRandom> = (o,a,b,rnd=op,io=0,ia=0,ib=0,so=1,sa=1,sb=1)=>{!o && (o=a);o[io]=rnd.minmax(a[ia],b[ib]);o[io+so]=rnd.minmax(a[ia+sa],b[ib+sb]);o[io+2*so]=rnd.minmax(a[ia+2*sa],b[ib+2*sb]);return o;};