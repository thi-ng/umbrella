...
describe("defuzz", () => {
    it("strategies", () => {
        ...
        const testStrategy = (strategy: DefuzzStrategy, expected: number[]) => {
            // const all = [];
            for (let i = 0, k = 0; i <= 10; i++) {
                for (let j = 0; j <= 10; j++, k++) {
                    ...
                    assert(
                        ...
                        `expected: ${expected[k]}, got: ${res.tip}`
                    );
        ...
        testStrategy(cogStrategy(), cogResults);
        ...
        testStrategy(maximaStrategy({ mode: "first" }), foMaResults);
        ...
        testStrategy(maximaStrategy({ mode: "last" }), loMaResults);
        ...
        testStrategy(maximaStrategy({ mode: "mean" }), meoMaResults);
