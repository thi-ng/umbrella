 ...
 */
export const mixS: VecOpSGVVV = (o,a,b,c,k,io=0,ia=0,ib=0,ic=0,so=1,sa=1,sb=1,sc=1) => {
!o&&(o=a);while(k-->0) {o[io+k*so]=a[ia+k*sa]+(b[ib+k*sb]-a[ia+k*sa])*c[ic+k*sc];}return o;
};