...
export const corner =
    (a: Readonly<Vec>, b: Readonly<Vec>, c: Readonly<Vec>) => {
        const ax = a[0];
        const ay = a[1];
...
export const classify =
    (a: Readonly<Vec>, b: Readonly<Vec>, c: Readonly<Vec>, eps = EPS) =>
...
export const classifyPointInTriangle2 =
    (p: Readonly<Vec>, a: Readonly<Vec>, b: Readonly<Vec>, c: Readonly<Vec>) => {
