 ...
 */
export const addmNS4: VecOpSVVN = (o,a,b,n,io=0,ia=0,ib=0,so=1,sa=1,sb=1) => {
!o && (o=a);o[io]=(a[ia]+b[ib])*n;o[io+so]=(a[ia+sa]+b[ib+sb])*n;o[io+2*so]=(a[ia+2*sa]+b[ib+2*sb])*n;o[io+3*so]=(a[ia+3*sa]+b[ib+3*sb])*n;return o;
};