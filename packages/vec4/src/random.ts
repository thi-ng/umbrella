 ...
 */
export const random4: VecOpOOO<number, number, IRandom> = (a,n=-1,m=1,rnd=op)=>{!a&&(a=[]);a[0]=rnd.minmax(n,m);a[1]=rnd.minmax(n,m);a[2]=rnd.minmax(n,m);a[3]=rnd.minmax(n,m);return a;};