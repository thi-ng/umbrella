...
export const i8array = (x: ArrayLike<number>): BinStructItem => [Type.I8_ARRAY, x];
export const u8 = (x: number): BinStructItem => [Type.U8, x];
export const u8array = (x: ArrayLike<number>): BinStructItem => [Type.U8_ARRAY, x];
export const i16 = (x: number, le = false): BinStructItem => [Type.I16, x, le];
export const i16array = (x: ArrayLike<number>, le = false): BinStructItem => [Type.I16_ARRAY, x, le];
export const u16 = (x: number, le = false): BinStructItem => [Type.U16, x, le];
export const u16array = (x: ArrayLike<number>, le = false): BinStructItem => [Type.U16_ARRAY, x, le];
export const i32 = (x: number, le = false): BinStructItem => [Type.I32, x, le];
export const i32array = (x: ArrayLike<number>, le = false): BinStructItem => [Type.I32_ARRAY, x, le];
export const u32 = (x: number, le = false): BinStructItem => [Type.U32, x, le];
export const u32array = (x: ArrayLike<number>, le = false): BinStructItem => [Type.U32_ARRAY, x, le];
export const f32 = (x: number, le = false): BinStructItem => [Type.F32, x, le];
export const f32array = (x: ArrayLike<number>, le = false): BinStructItem => [Type.F32_ARRAY, x, le];
export const f64 = (x: number, le = false): BinStructItem => [Type.F64, x, le];
export const f64array = (x: ArrayLike<number>, le = false): BinStructItem => [Type.F64_ARRAY, x, le];
            ...
            (acc, [type, x, le = false]) => {
                ...
                switch (type) {
                    ...
                    case Type.I8_ARRAY: {
                        ...
                        acc = ensure(acc, n);
                        new Int8Array(acc.buffer, acc.byteOffset).set(<ArrayLike<number>>x, pos);
                        pos += n;
                        break;
                    }
                    case Type.U8:
                    ...
                    case Type.I16_ARRAY: {
                        ...
                        const n = x.length;
                        acc = ensure(acc, 2 * n);
                        for (let i = 0; i < n; i++ , pos += 2) view.setInt16(pos, x[i], le);
                        break;
                    }
                    case Type.U16:
                        acc = ensure(acc, 4);
                    ...
                    case Type.U16_ARRAY: {
                        ...
                        const n = x.length;
                        acc = ensure(acc, 2 * n);
                        for (let i = 0; i < n; i++ , pos += 2) view.setUint16(pos, x[i], le);
                        break;
                    }
                    case Type.I32:
                        acc = ensure(acc, 4);
                    ...
                    case Type.I32_ARRAY: {
                        ...
                        const n = x.length;
                        acc = ensure(acc, 4 * n);
                        for (let i = 0; i < n; i++ , pos += 4) view.setInt32(pos, x[i], le);
                        break;
                    }
                    case Type.U32:
                        acc = ensure(acc, 4);
                    ...
                    case Type.U32_ARRAY: {
                        ...
                        const n = x.length;
                        acc = ensure(acc, 4 * n);
                        for (let i = 0; i < n; i++ , pos += 4) view.setUint32(pos, x[i], le);
                        break;
                    }
                    case Type.F32:
                        acc = ensure(acc, 4);
                    ...
                    case Type.F32_ARRAY: {
                        ...
                        const n = x.length;
                        acc = ensure(acc, 4 * n);
                        for (let i = 0; i < n; i++ , pos += 4) view.setFloat32(pos, x[i], le);
                        break;
                    }
                    case Type.F64:
                        acc = ensure(acc, 8);
                    ...
                    case Type.F64_ARRAY: {
                        ...
                        const n = x.length;
                        acc = ensure(acc, 8 * n);
                        for (let i = 0; i < n; i++ , pos += 8) view.setFloat64(pos, x[i], le);
                        break;
                    }
                    case Type.STR: {
