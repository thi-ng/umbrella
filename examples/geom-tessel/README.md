...
![screenshot](https://codeberg.org/thi.ng/umbrella/media/branch/develop/assets/geom/tessel.png)

[Live demo](http://demo.thi.ng/umbrella/geom-tessel/)

Test example of
[@thi.ng/geom](https://codeberg.org/thi.ng/umbrella/src/branch/develop/packages/geom)'s
...
interface](https://codeberg.org/thi.ng/umbrella/src/branch/develop/packages/api/src/api.ts#L415).
